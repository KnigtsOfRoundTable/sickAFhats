...
<div class="row">
    <article class="col-xs-6">
        <figure><img src="img/enter.jpg" alt="fish"/></figure>
    </article>
...
<div class="row">
    ...
    <article class="col-xs-6">
        <figure class="right w50"><img src="img/food6.jpg" alt="fish"/></figure>
    </article>
</div><!--end row--> 

<div class="row">
    <article class="col-xs-6">
        <figure><img src="img/table.jpg" alt="fish"/></figure>
    </article>
...
<div class="row">
    ...
    <article class="col-xs-6">
        <figure class="right w50"><img src="img/food4.jpg" alt="fish"/></figure>
    </article>
</div><!--end row-->
